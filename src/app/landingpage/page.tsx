...
const testimonials = [
  {
    ...
    content: "以前用其他钱包总觉得麻烦又不安全，直到试了 ClawWallet - 3 秒钟就完成创建，现在我的 AI Agent 可以帮我管理加密资产，完全不用担心安全问题。TEE 架构确实让人放心！",
    contentEn: "I used to find other wallets complicated and insecure, but ClawWallet changed everything - it only took 3 seconds to create, and now my AI Agent manages my crypto assets without any security worries. The TEE architecture really gives me peace of mind!",
    rating: 5,
  },
  {
    name: "0xyilu",
    ...
    content: "第一次接触加密货币，本来还担心学不会，结果 ClawWallet 3 秒钟就创建完成了。现在我只需要跟 OpenClaw Agent 说说话，它就会自动处理交易，完全不用了解复杂的技术知识，太适合新手了！",
    contentEn: "First time getting into crypto, I was worried it would be too complicated, but ClawWallet was ready in just 3 seconds. Now I just talk to my OpenClaw Agent and it handles all transactions automatically - no technical knowledge needed, perfect for beginners!",
    rating: 5,
  },
  {
    name: "seven_nad",
    ...
    content: "一直害怕私钥丢了或者被盗，ClawWallet 的无私钥设计解决了我的后顾之忧。3 秒钟创建完成后，我的 AI Agent 可以在我设定的范围内自主操作，而且所有交易都有记录，感觉对资产的控制更踏实了。",
    contentEn: "I've always been afraid of losing or having my private keys stolen, but ClawWallet's keyless design solves that. Created in just 3 seconds, now my AI Agent operates within my set limits, and all transactions are recorded - I feel much more secure about my assets.",
    rating: 5,
  },
];
