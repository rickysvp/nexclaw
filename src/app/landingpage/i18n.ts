...
export const translations = {
  ...
  testimonialsContent: {
    user1: {
      name: { zh: '张先生', en: 'Mr. Zhang', ja: '張さん', ko: '장 씨', fr: 'M. Zhang', de: 'Herr Zhang', es: 'Sr. Zhang' },
      role: { zh: 'DeFi 投资者', en: 'DeFi Investor', ja: 'DeFi 投資家', ko: 'DeFi 투자자', fr: 'Investisseur DeFi', de: 'DeFi-Investor', es: 'Inversor DeFi' },
      content: {
    ...
    user2: {
      name: { zh: '李女士', en: 'Ms. Li', ja: '李さん', ko: '이 씨', fr: 'Mme Li', de: 'Frau Li', es: 'Sra. Li' },
      role: { zh: '加密货币爱好者', en: 'Crypto Enthusiast', ja: '暗号通貨愛好家', ko: '암호화폐 애호가', fr: 'Passionné de Crypto', de: 'Krypto-Enthusiast', es: 'Entusiasta de Cripto' },
      content: {
    ...
    user3: {
      name: { zh: '王先生', en: 'Mr. Wang', ja: '王さん', ko: '왕 씨', fr: 'M. Wang', de: 'Herr Wang', es: 'Sr. Wang' },
      role: { zh: 'Web3 探索者', en: 'Web3 Explorer', ja: 'Web3 探検家', ko: 'Web3 탐험가', fr: 'Explorateur Web3', de: 'Web3-Explorer', es: 'Explorador Web3' },
      content: {
