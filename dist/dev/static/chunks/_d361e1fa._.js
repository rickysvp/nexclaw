...
// ============================================
// Color Palette - Playful Geometric
const colors = {
    background: '#FFFDF5',
    // warm cream
    foreground: '#1E293B',
...
const GeometricDecorations = {
    YellowCircle: ({ className = '', size = 120 })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    PinkCircle: ({ className = '', size = 80 })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: `absolute rounded-full ${className}`,
            style: {
                width: size,
                height: size,
    ...
    MintCircle: ({ className = '', size = 60 })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: `absolute rounded-full ${className}`,
            style: {
                width: size,
                height: size,
    ...
    OrangeCircle: ({ className = '', size = 100 })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: `absolute rounded-full ${className}`,
            style: {
                width: size,
                height: size,
    ...
    Triangle: ({ className = '', size = 60 })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    DotPattern: ({ className = '' })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: `absolute inset-0 ${className} bg-dot-grid`
        }, void 0, false, {
            fileName: "[project]/src/app/page.tsx",
            lineNumber: 93,
            columnNumber: 9
        }, ("TURBOPACK compile-time value", void 0)),
    StripePattern: ({ className = '' })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: `absolute inset-0 ${className} bg-diagonal-stripes opacity-30`
        }, void 0, false, {
            fileName: "[project]/src/app/page.tsx",
            lineNumber: 98,
            columnNumber: 9
...
const securityLayers = [
    {
        ...
        title: 'TEE 可信执行环境',
        subtitle: '硬件级密钥分片保护',
        desc: '基于 AWS Nitro Enclaves 构建，私钥在硬件隔离的可信执行环境中分片加密，充分利用亚马逊云的安全与合规基础设施。',
        highlights: [
            '硬件隔离',
            '密钥分片',
            'AWS 合规'
    ...
    },
    {
        ...
        title: '五层交易过滤引擎',
        subtitle: '实时风险监控与拦截',
        desc: 'Agent 发起的每笔交易在广播前都需经过五层安全检查：金额限制、合约白名单、频率控制、审批工作流和实时风险监控。',
        highlights: [
            '五层检查',
            '实时拦截',
            '自动防护'
    ...
    },
    {
        ...
        title: '多因素交易确认',
        subtitle: '高价值操作二次授权',
        desc: '超出用户设定阈值的交易将触发推送通知，需要通过 App 或邮件进行二次授权后才能广播，确保大额资产安全。',
        highlights: [
            '阈值触发',
            '推送通知',
            '二次授权'
    ...
    },
    {
        ...
        title: '智能合约风险扫描',
        subtitle: '集成 Bitslab Safe API',
        desc: '在 Agent 与合约交互前自动扫描目标合约的风险评分和漏洞，拦截高风险合约并发出警报，防范恶意合约攻击。',
        highlights: [
            '自动扫描',
            '风险评分',
            '恶意拦截'
    ...
    },
    {
        ...
        title: '端到端加密通信',
        subtitle: 'TLS 1.3 + 消息签名',
        desc: 'OpenClaw Agent 与 Claw Wallet 之间的所有通信均采用 TLS 1.3 和消息级签名加密，有效防止中间人攻击。',
        highlights: [
            'TLS 1.3',
            '消息签名',
            '防中间人'
    ...
    create: {
        ...
        chatContent: {
            messages: [
                {
                    role: 'user',
                    content: '帮我创建一个新的加密钱包'
                },
                {
                    role: 'agent',
                    content: '好的，我将为你创建一个安全的加密钱包。\n\n正在初始化...\n• 安全级别: 高\n• 支持链: Ethereum, Base, Arbitrum, Optimism\n• 加密方式: TEE 硬件加密\n• 备份方式: 助记词'
                },
                {
                    role: 'user',
                    content: '确认创建这个钱包'
                ...
                {
                    role: 'agent',
                    content: '✓ 钱包创建成功！\n地址: 0x7a8b...3c4d\n\n重要提示：请务必保存好你的助记词，这是恢复钱包的唯一方式。\n你可以在设置中查看钱包详情和管理多链地址。\n\nClaw Wallet 正在保护你的加密资产'
                }
            ]
        }
    },
    market: {
        ...
        chatContent: {
            messages: [
                {
                    role: 'user',
                    content: '帮我查看今天的加密市场动态'
                },
                {
                    role: 'agent',
                    content: '好的，正在为你收集最新的市场信息...\n\n📊 市场概览\n• 比特币: $69,850 (+2.3%)\n• 以太坊: $3,845 (+1.7%)\n• 市场总市值: $2.31T (+1.9%)\n\n📰 热点新闻\n• 比特币突破 70,000 美元关口\n• 以太坊上海升级成功完成\n• DeFi 总锁仓量增长 15%\n\n💬 KOL 观点\n• @CryptoExpert: 看好 Solana 未来表现\n• @BlockchainAnalyst: 市场情绪偏向乐观'
                },
                {
                    role: 'user',
                    content: '我想订阅市场动态'
    ...
    price: {
        ...
        chatContent: {
            messages: [
                {
                    role: 'user',
                    content: '帮我跟踪比特币和以太坊的价格'
                },
                {
                    role: 'agent',
                    content: '好的，正在获取实时价格数据...\n\n🟢 比特币 (BTC)\n• 当前价格: $69,500.00\n• 24h变化: +2.5%\n• 24h最高: $70,120.00\n• 24h最低: $68,350.00\n• 交易量: $25.2B\n\n🟢 以太坊 (ETH)\n• 当前价格: $3,850.00\n• 24h变化: +1.8%\n• 24h最高: $3,885.00\n• 24h最低: $3,790.00\n• 交易量: $19.8B\n\n📊 市场总览\n• 总市值: $2.3T\n• 24h交易量: $45B'
                },
                {
                    role: 'user',
                    content: '帮我设置价格预警'
    ...
    arbitrage: {
        ...
        chatContent: {
            messages: [
                {
                    role: 'user',
                    content: '帮我设置一个自动套利策略'
                },
                {
                    role: 'agent',
                    content: '好的，正在分析当前市场的套利机会...\n\n📈 套利机会分析\n• 交易所对: Binance vs OKX\n• 目标代币: ETH\n• 当前套利空间: 0.5%\n• 预计日收益: $50\n• 风险等级: 低\n• 资金需求: $10,000\n• 预计年化: 18.25%\n\n⚡ 执行策略\n• 自动监控价格差异\n• 达到阈值自动执行\n• 智能 Gas 费优化\n• 24/7 持续运行'
                },
                {
                    role: 'user',
                    content: '确认设置这个套利策略'
    ...
    mining: {
        ...
        chatContent: {
            messages: [
                {
                    role: 'user',
                    content: '帮我在 DeFi 协议中挖矿'
                },
                {
                    role: 'agent',
                    content: '好的，正在分析当前最优质的挖矿机会...\n\n🏦 挖矿协议分析\n• 协议: Aave V3\n• 代币: USDC\n• 年化收益: 12.5%\n• 锁定期: 30 天\n• 风险等级: 中\n• 最低投资: 100 USDC\n• 安全性: 经过审计\n• 流动性: 高\n\n📊 收益预测\n• 100 USDC 投资: 约 1.04 USDC/月\n• 500 USDC 投资: 约 5.21 USDC/月\n• 1000 USDC 投资: 约 10.42 USDC/月'
                },
                {
                    role: 'user',
                    content: '我想投资 100 USDC 参与挖矿'
                },
                {
                    role: 'agent',
                    content: '✓ 已成功参与挖矿！\n• 投资金额: 100 USDC\n• 选择协议: Aave V3\n• 预计年化: 12.5%\n• 开始计息时间: 立即\n• 可在 DeFi 中心查看实时收益\n• 支持提前赎回（可能有手续费）\n\nClaw Wallet 正在保护你的加密资产'
    ...
    meme: {
        ...
        chatContent: {
            messages: [
                {
                    role: 'user',
                    content: '我想设置自动 meme 打狗策略'
                },
                {
                    role: 'agent',
                    content: '正在分析 meme 市场...\n\n当前热点: PEPE, DOGE, SHIB\n市场情绪: 极度看涨\n风险等级: 高\n潜在收益: 50-100%\n\n📈 策略分析\n• 入场时机: 市场情绪转为看涨时\n• 止盈点: 30-50% 收益\n• 止损点: -15%\n• 资金分配: 不超过总资金的 10%'
                },
                {
                    role: 'user',
                    content: '确认设置'
                ...
                {
                    role: 'agent',
                    content: '✓ 自动 meme 打狗策略已设置！\n• 策略 ID: MEME-2024\n• 已开始监控 meme 币市场\n• 将在合适时机自动执行交易\n• 可在策略中心查看详情\n• 风险提示：Meme 币波动较大，请谨慎投资\n\nClaw Wallet 正在保护你的加密资产'
                }
            ]
        }
    },
    ...
    transfer: {
        ...
        chatContent: {
            messages: [
                {
                    role: 'user',
                    content: '我想转 2 ETH 给 0x742d...f0bEb'
                },
                {
                    role: 'agent',
                    content: '正在准备交易...\n\n📋 交易详情\n• 发送方: 0x7a8b...3c4d\n• 接收方: 0x742d...f0bEb\n• 金额: 2 ETH\n• Gas 费: 0.001 ETH\n• 总计: 2.001 ETH\n• 网络: Ethereum\n• 预计确认时间: 12-30 秒\n\n🔍 地址验证\n• 地址格式: 有效\n• 链: Ethereum\n• 风险检查: 安全'
    ...
    defi: {
        ...
        chatContent: {
            messages: [
                ...
                {
                    role: 'agent',
                    content: '正在查询最优兑换路径...\n\n📊 兑换选项\n• Uniswap V3: 0.3842 ETH (滑点 0.05%)\n• Curve: 0.3839 ETH (滑点 0.08%)\n• 1inch: 0.3841 ETH (滑点 0.06%)\n\n⚡ 推荐方案\n• 协议: Uniswap V3\n• 预计获得: 0.3842 ETH\n• 滑点: 0.05%\n• Gas 费预估: 0.002 ETH\n• 总费用: 1000 USDC + 0.002 ETH'
                },
                {
                    role: 'user',
                    content: '确认兑换'
    ...
    staking: {
        ...
        chatContent: {
            messages: [
                {
                    role: 'user',
                    content: '我想质押 ETH 获得收益'
                },
                {
                    role: 'agent',
                    content: '正在查询质押选项...\n\n📋 质押方案对比\n• Lido: 5.2% APY · 流动性好 · 去中心化\n• Rocket Pool: 5.5% APY · 更高收益 · 社区驱动\n• Coinbase: 4.8% APY · 安全可靠 · 中心化\n\n⚡ 推荐方案\n• 协议: Lido\n• 年化收益: 5.2%\n• 流动性: 高 (stETH)\n• 风险: 低\n• 最低质押: 0.1 ETH'
                },
                {
                    role: 'user',
                    content: '选择 Lido'
...
// ============================================
// Components - Playful Geometric Design
// ============================================
// Pill Badge with hard shadow
const Badge = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(5);
    if ($[0] !== "74dd704733f9b30f2059e9192989b680b9d88c861f4ba7aadb65149281ba7ae7") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "74dd704733f9b30f2059e9192989b680b9d88c861f4ba7aadb65149281ba7ae7";
    }
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = {
            default: "bg-orange-100 text-orange-600 border-2 border-orange-200",
            outline: "bg-transparent text-slate-700 border-2 border-slate-300",
            ghost: "bg-transparent text-slate-500 border-2 border-transparent",
            pink: "bg-pink-100 text-pink-600 border-2 border-pink-200",
            yellow: "bg-yellow-100 text-yellow-600 border-2 border-yellow-200",
            mint: "bg-emerald-100 text-emerald-600 border-2 border-emerald-200"
        };
        $[1] = t3;
    } else {
        t3 = $[1];
    ...
    const variants = t3;
    const t4 = `inline-flex items-center gap-1.5 px-4 py-2 text-sm font-semibold rounded-full transition-all duration-200 hover:scale-105 ${variants[variant]} ${className}`;
    let t5;
    if ($[2] !== children || $[3] !== t4) {
...
const Button = (t0)=>{
    ...
    const { children, variant: t1, size: t2, className: t3, icon: Icon, onClick } = t0;
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = {
            primary: "bg-orange-500 text-white border-2 border-slate-800 shadow-hard hover:shadow-hard-hover hover:-translate-y-1 active:shadow-hard-active active:translate-y-0",
            secondary: "bg-white text-slate-800 border-2 border-slate-300 shadow-hard-sm hover:shadow-hard hover:-translate-y-1 active:shadow-hard-sm active:translate-y-0",
            ghost: "bg-transparent text-slate-600 hover:bg-slate-100 border-2 border-transparent",
            outline: "bg-transparent text-slate-800 border-2 border-slate-400 hover:border-slate-800 hover:bg-slate-50",
            white: "bg-white text-slate-800 border-2 border-slate-200 shadow-hard-sm hover:shadow-hard hover:-translate-y-1"
        };
        $[1] = t4;
    } else {
        t4 = $[1];
    ...
    const sizes = t5;
    const t6 = `${"inline-flex items-center justify-center gap-2 font-bold transition-all duration-200 rounded-full"} ${variants[variant]} ${sizes[size]} ${className}`;
    let t7;
    if ($[3] !== Icon) {
    ...
    let t8;
    if ($[5] !== children || $[6] !== onClick || $[7] !== t6 || $[8] !== t7) {
...
_c1 = Button;
// Sticker Card with hard shadow and wiggle
const Card = (t0)=>{
    ...
    const { children, className: t1, hover: t2, featured: t3 } = t0;
    const className = t1 === undefined ? "" : t1;
    const hover = t2 === undefined ? false : t2;
    const featured = t3 === undefined ? false : t3;
    const t4 = `bg-white rounded-2xl border-2 border-slate-800 ${featured ? "shadow-hard-accent" : "shadow-hard-sm"} ${hover ? "hover:shadow-hard hover:-translate-y-2 animate-wiggle-hover" : ""} transition-all duration-200 ${className}`;
    let t5;
    if ($[1] !== children || $[2] !== t4) {
...
//# sourceMappingURL=_d361e1fa._.js.map